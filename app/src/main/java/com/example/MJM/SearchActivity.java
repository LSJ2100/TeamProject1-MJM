    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Intent : 페이지 -> 페이지(화면전환) or 페이지 -> 데이터 전달할 수 있게 하는 객체
            }
//            public void isSearch(View v){
//                switch (v.getId()) {
...
//                }
//            }
            // 검색 버튼을 누르면, 검색 된 데이터에 따라 Camera를 바꾸려는 기능을 구현 하려함.
        });
...
//        setContentView(binding.getRoot());
    ...
    private void settingList() { //검색에 사용될 데이터 리스트 추가
        list.add("Y1234");
        list.add("Y2234");
        list.add("Y3234");
        list.add("Y4234");
